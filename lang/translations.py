"""
Sistema de internacionalizaÃ§Ã£o do AimPointer
"""
...
LANGUAGES = {
    "en": {
        ...
        "calibration_step2": "Rotate 90Â° to the left", 
        "calibration_step3": "Rotate 90Â° to the right",
    ...
    "pt": {
        ...
        "buttons_start_calibration": "Iniciar CalibraÃ§Ã£o",
        "buttons_reset_calibration": "Resetar CalibraÃ§Ã£o",
        
        # Menu & Sections
        "menu_settings": "ConfiguraÃ§Ãµes",
        "menu_connection": "ConexÃ£o",
        "menu_sensors": "Sensores",
        "menu_sensitivity": "Sensibilidade",
        "menu_calibration": "CalibraÃ§Ã£o",
        "menu_stabilization": "EstabilizaÃ§Ã£o",
        
        # Labels
        "labels_server_ip": "IP do Servidor",
        "labels_direction_x": "DireÃ§Ã£o X",
        "labels_direction_y": "DireÃ§Ã£o Y",
        "labels_rotation_z": "RotaÃ§Ã£o Z",
        "labels_accuracy": "PrecisÃ£o", 
        "labels_sensitivity": "Sensibilidade",
        "labels_smoothing": "SuavizaÃ§Ã£o",
        "labels_compensation": "CompensaÃ§Ã£o",
        "labels_sensor_fusion": "FusÃ£o de Sensores",
        
        # Messages
        "messages_connecting": "Conectando ao servidor...",
        "messages_connected": "Conectado com sucesso!",
        "messages_disconnected": "Desconectado",
        "messages_sensor_error": "Erro nos sensores - verifique permissÃµes",
        "messages_calibration_complete": "CalibraÃ§Ã£o concluÃ­da com sucesso!",
        "messages_calibration_started": "CalibraÃ§Ã£o iniciada - siga os passos",
        "messages_initial_position_set": "PosiÃ§Ã£o inicial definida!",
        
        # Instructions
        "instructions_title": "Controle por Ponteiro",
        "instructions_body": "Aponte o dispositivo como um controle remoto. O cursor seguirÃ¡ naturalmente sua direÃ§Ã£o.",
        "instructions_calibration": "Mantenha o dispositivo estÃ¡vel durante a calibraÃ§Ã£o para melhores resultados.",
        
        # Calibration Steps
        "calibration_step1": "Defina a posiÃ§Ã£o inicial de referÃªncia",
        "calibration_step2": "Gire 90Â° para a esquerda",
        "calibration_step3": "Gire 90Â° para a direita", 
        "calibration_step4": "Volte para a posiÃ§Ã£o inicial",
        
        # Errors
        "error_connection_failed": "ConexÃ£o falhou - verifique IP e servidor",
        "error_sensors_not_supported": "Sensores de movimento nÃ£o suportados pelo navegador",
        "error_permission_denied": "PermissÃ£o negada para sensores de movimento",
        
        # Performance
        "performance_fps": "FPS",
        "performance_resolution": "ResoluÃ§Ã£o",
        "performance_latency": "LatÃªncia"
    }
}

def get_translation(lang="en"):
    """Retorna as traduÃ§Ãµes para o idioma especificado"""
...
def t(key, default=None):
    """FunÃ§Ã£o de atalho para traduÃ§Ã£o rÃ¡pida"""
